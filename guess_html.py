...
# Step 1: Request an HTML content from the user
    
user_html = input("Enter the cleaned HTML code: ")

# Step 2: Create GPT prompt
gpt_prompt_system = f"""
Analyze the provided HTML from a Shopify e-commerce cart page.
Your task is to find the main 'Checkout' button and the main 'cart form', avoiding any other buttons related to mini-carts, sidebar or other secondary forms.
...
# Step 3: Send prompt to GPT and get response
